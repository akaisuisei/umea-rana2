...
namespace Umea_rana
{
    public class IA_Manager_max
    {
        ...
        {
            ia_manage.Add(new Stalker(_texture, new Rectangle((int)(X * window_W) + 1, (int)(Y * window_H) - 1, _rectangle.Width, _rectangle.Height), front_sc, speed, window_H, window_W, 0, id));
        }
