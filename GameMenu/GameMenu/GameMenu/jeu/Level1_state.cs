...
namespace Umea_rana
{
    ...
    public class Level1_state : GameState
    {
        ...
        public Level1_state(Game1 game1, GraphicsDeviceManager graphics, ContentManager content)
        {
        ...
        public override void LoadContent(ContentManager Content)
        {
            ...
            //platfom
            sol = new platform(Content.Load<Texture2D>("platform"), new Rectangle(0, height/6*5, width, height / 15), 4);
            sol2 = new platform(Content.Load<Texture2D>("platform"), new Rectangle(width-150, height/6*4, width, height / 15), 4);
        }
