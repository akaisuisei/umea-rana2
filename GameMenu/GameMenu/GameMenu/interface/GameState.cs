...
namespace Umea_rana
{
    public abstract class GameState
    {
        ...
        public abstract void LoadContent(ContentManager Content,  GraphicsDevice Graph,ref string level,ref string next,GraphicsDeviceManager graphics, Audio audio);
